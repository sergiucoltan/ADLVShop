INSERT INTO dbo.Products(Product_Name,Product_Description,Product_Price,Available_Items) VALUES ('Bumper Stickers','Stickers / Bumper Stickers  - Adhesive label or sticker with ADLV logo',9.99,100);
INSERT INTO dbo.Products(Product_Name,Product_Description,Product_Price,Available_Items) VALUES ('CDs','Get the new ADLV Album, with member signatures',29.99,100);
INSERT INTO dbo.Products(Product_Name,Product_Description,Product_Price,Available_Items) VALUES ('T-shirts','Shop high-quality unique Description T-Shirts designed and sold by ADLV. Available in a range of colours and styles for men, women, and everyone.',59.99,100);
INSERT INTO dbo.Products(Product_Name,Product_Description,Product_Price,Available_Items) VALUES ('Matchboxes','Check out our custom matchboxes selection for the very best in unique or custom, with ADLV logo',9.99,100);
INSERT INTO dbo.Products(Product_Name,Product_Description,Product_Price,Available_Items) VALUES ('Posters','Check out our posters selection for the very best in unique or custom',19.99,100);
INSERT INTO dbo.Products(Product_Name,Product_Description,Product_Price,Available_Items) VALUES ('Autographed photos','Check out our photos selection for the very best in unique or custom',14.99,100);
INSERT INTO dbo.Products(Product_Name,Product_Description,Product_Price,Available_Items) VALUES ('Lighters','Check out our custom lighters selection for the very best in unique or custom, with ADLV logo',14.99,100);
